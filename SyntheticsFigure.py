...
l=50000
df1=makeLinear2(l, 5, 5, 10000, 100000, label=1)
df1=df1.append(makeLinear2(l, 30, 2, 0, 10000,ndikes=10, label=2))
df1['Label']=df1['Label'].astype(str)
DotsLines(df1, ColorBy='Label', CbarLabels=False)
...
DotsLines(df2, ColorBy='Label', CbarLabels=False)
...
DotsLines(df3, ColorBy='Label', CbarLabels=False)
